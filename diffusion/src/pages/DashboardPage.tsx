...
export function DashboardPage() {
  ...
  const stats = [
    { label: "전체 진도", value: `${overall.percent}%`, icon: ChartColumn, sub: `노트북 ${overall.completedNotebooks}/${overall.totalNotebooks}` },
    ...
    <div className="space-y-10">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Diffusion &amp; Gen AI Course · 10파트 학습 허브
        </p>
      </header>
      ...
      <section>
        ...
        {recent.length === 0 ? (
          <div className="rounded-xl border border-dashed border-border p-8 text-center text-sm text-muted-foreground">
            아직 학습 기록이 없어요. 첫 파트의 노트북을 완료해 보세요.
          </div>
        ) : (
