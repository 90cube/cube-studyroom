// Dashboard: header + stat grid + learning roadmap + recent timeline.
// Render-only; reads overall/timeline from useStudy().
...
export function DashboardPage() {
  ...
  const stats = [
    { label: "전체 진도", value: `${overall.percent}%`, icon: ChartColumn, sub: `문서 ${overall.completedNotebooks}/${overall.totalNotebooks}` },
    ...
    <div className="space-y-10">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Hugging Face diffusers 라이브러리 · 8파트 코드 리딩 + 사용법
        </p>
      </header>
